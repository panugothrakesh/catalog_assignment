...
function Introduction() {
  return (
    ...
    <div className='flex flex-col'>
        ...
        <p className='text-lg text-[#6F7177] leading-8 md:w-3/4 w-full'>As part of the interview process, I was assigned a task to convert a provided Figma design into a functional ReactJS component using Recharts and API to fetch the Data. The goal was to accurately replicate the visual design and ensure the component is interactive.</p>
